 ...
 */
class almighty_Dropdown_Taxonomies_Control extends WP_Customize_Control
{
 ...
 * @see WP_Customize_Control
 */
class almighty_Radio_Image_Control extends WP_Customize_Control
{
...
if (!function_exists('almighty_is_select_page_slider')) :
     ...
     */
    function almighty_is_select_page_slider($control)
    {
...
if (!function_exists('almighty_is_select_cat_slider')) :
     ...
     * @return bool Whether the control is active to the current preview.
     */
    function almighty_is_select_cat_slider($control)
    {
...
if (!function_exists('almighty_sanitize_select')) :
     ...
     */
    function almighty_sanitize_select($input, $setting)
    {
...
if (!function_exists('almighty_sanitize_checkbox')) :
     ...
     */
    function almighty_sanitize_checkbox($checked)
    {
...
if (!function_exists('almighty_sanitize_positive_integer')) :
     ...
     */
    function almighty_sanitize_positive_integer($input, $setting)
    {
...
if (!function_exists('almighty_sanitize_dropdown_pages')) :
     ...
     */
    function almighty_sanitize_dropdown_pages($page_id, $setting)
    {
...
if (!function_exists('almighty_sanitize_image')) :
     ...
     */
    function almighty_sanitize_image($image, $setting)
    {
...
if (!function_exists('almighty_sanitize_number_range')) :
     ...
     */
    function almighty_sanitize_number_range($input, $setting)
    {
 ...
 * @access public
 */
class Almighty_Customize_Section_Upsell extends WP_Customize_Section {
