...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			'top_bar_background_color' => '#2653e7',
			'top_bar_text_color' => '#fbe888',
			'top_bar_link_color' => '#fbe888',
			'top_bar_link_color_hover' => '#ffffff',
			'header_background_color' => '#a9c0c6',
			'header_text_color' => '#223333',
			'header_link_color' => '#223333',
			'header_link_hover_color' => '#223333',
			'site_title_color' => '#fbe888',
			'site_tagline_color' => '#223333',
			'navigation_background_color' => '#a9c0c6',
			'navigation_text_color' => '#223333',
			'navigation_background_hover_color' => '',
			'navigation_text_hover_color' => '#fbe888',
			'navigation_background_current_color' => '',
			'navigation_text_current_color' => '',
			'subnavigation_background_color' => '#2653e7',
			'subnavigation_text_color' => '#fbe888',
			...
			'fixed_side_content_background_color' => '#2653e7',
			'fixed_side_content_text_color' => '#fbe888',
			'fixed_side_content_link_color' => '#fbe888',
			...
			'content_title_color' => '',
			'blog_header_bg_color' => '#a9c0c6',
			'blog_header_bg_s_color' => '#223333',
			'blog_header_title_color' => '#fbe888',
			'blog_header_text_color' => '#223333',
			'blog_header_button' => '#223333',
			'blog_header_button_bg' => '#fbe888',
			'blog_header_button_hover' => '#223333',
			...
			'h5_color' => '',
			'h6_color' => '',
			'sidebar_widget_background_color' => '#a9c0c6',
			'sidebar_widget_text_color' => '#223333',
			'sidebar_widget_link_color' => '#fbe888',
			'sidebar_widget_link_hover_color' => '#ffffff',
			'sidebar_widget_title_color' => '#fbe888',
			'footer_widget_background_color' => '#a9c0c6',
			'footer_widget_text_color' => '#223333',
			'footer_widget_link_color' => '#fbe888',
			'footer_widget_link_hover_color' => '#ffffff',
			'footer_widget_title_color' => '#fbe888',
			'footer_background_color' => '#2653e7',
			'footer_text_color' => '#fbe888',
			'footer_link_color' => '#fbe888',
			...
			'form_button_background_color' => '#fbe888',
			'form_button_background_color_hover' => '#2653e7',
			'form_button_text_color' => '#223333',
			'form_button_text_color_hover' => '#ffffff',
			'back_to_top_background_color' => 'rgba(251,232,136,0.7)',
			'back_to_top_background_color_hover' => '#fbe888',
			'back_to_top_text_color' => '#2653e7',
			'back_to_top_text_color_hover' => '#2653e7',
		);
...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			...
			'font_blog_header_title' => 'Open Sans',
			'font_blog_header_title_category' => '',
			'font_blog_header_title_variants' => '300,regular,600,700,800',
			...
			'font_navigation_variants' => '300,regular,600,700,800',
			'navigation_font_weight' => '800',
			'navigation_font_transform' => 'uppercase',
			'navigation_font_size' => '19',
			'font_widget_title' => 'Open Sans',
			'font_widget_title_category' => '',
			'font_widget_title_variants' => '300,regular,600,700,800',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Roboto:100,300,regular,500,700,900|Open+Sans:300,regular,600,700,800' );
